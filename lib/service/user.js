...
module.exports = {
  ...
  // 暂不对第三方应用开放
  checkCookie: function (cookie, signature, options) {
    return this.requestWithSelfToken(Object.assign({
      method: 'POST',
      url: '/v1/users/verify/cookie',
      data: { cookie, signed: signature }
    }, options), '', '')
  },

  // 暂不对第三方应用开放
  checkToken: function (accessToken, options) {
    return this.requestWithSelfToken(Object.assign({
      method: 'POST',
      url: '/v1/users/verify/token',
